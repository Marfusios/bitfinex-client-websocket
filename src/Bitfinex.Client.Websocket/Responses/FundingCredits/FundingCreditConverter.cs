...
class FundingCreditConverter : JsonConverter
{
    public override bool CanConvert(Type objectType)
    {
        return objectType == typeof(FundingCredit);
    }
    ...
    FundingCredit JArrayToTradingTicker(JArray array)
    {
        return new FundingCredit
        {
            Id = (long)array[0],
