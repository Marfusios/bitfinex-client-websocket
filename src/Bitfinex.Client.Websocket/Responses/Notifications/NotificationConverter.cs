...
class NotificationConverter : JsonConverter
{
    ...
    Notification JArrayToNotification(JArray array)
    {
    ...
    static NotificationType ParseNotificationType(string type)
    {
        ...
        BitfinexJsonSerializer.AuthenticatedLogger.LogWarning(BitfinexLogMessage.Authenticated("Can't parse NotificationType, input: " + safe));
        return NotificationType.Undefined;
    }
}